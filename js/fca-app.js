...
(function() {
  var App, AttributesForm, B, ExampleAdd, ExampleRow, ExamplesHeading, ExamplesTable, LinkedState, R, RC, RulesList, br, button, caption, delay, div, form, hideIf, input, label, li, manualRelation, p, small, table, tbody, td, th, thead, tr, ul, _ref;
  ...
  ExamplesTable = RC({
    render: function() {
      ...
      return div(hideIf(!this.props.attributes.length), [
        p({}, ['Добавляйте примеры, пока все выводы не будут истинны.', br({}), small({}, 'Предпосылка: все заключения от наличия одного набора свойств к наличию другого истинны, пока не показано обратное.')]), table({}, [
